...
if (process.env.ENTORNO === 'PRO') {
	//rest.put(Routes.applicationCommands(process.env.CLIENT_ID), { body: [] }) -> Permite limpiar comandos forzadamente
	...
	//rest.put(Routes.applicationGuildCommands(process.env.CLIENT_ID, process.env.GUILD_ID_DEV), { body: [] }) -> Permite limpiar comandos forzadamente
